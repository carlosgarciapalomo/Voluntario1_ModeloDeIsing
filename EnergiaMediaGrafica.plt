...
set label 1 "Energia Media N=16" at graph 0.5,0.95 font "arial bold,12" center
...
plot "EnergiaMedia.txt" using 1:2:3 with yerrorbars title "ERROR" ls 2 lc rgb "red", \
